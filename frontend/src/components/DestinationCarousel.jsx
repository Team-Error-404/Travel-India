      ...
      <Link className="px-3 nav-link state" to="/" >
        <div className="card" >
          ...
          <div className="card-body top-state-body">
            ...
            <h5>Uttar Pradesh</h5>
            <p className="card-text text-muted text-left">One of the seven wonders of the world, Taj Mahal is located on the banks of River Yamuna in Agra. It was built by the Mughal Emperor Shah Jahan as a memorial for his third wife, Mumtaz Mahal. Constructed entirely out of white marble in the 17th century, Taj Mahal is one of the most beautiful monuments in the world.</p>
          </div>
        </div>
      </Link>
      <Link className="px-3 nav-link state" to="/">
